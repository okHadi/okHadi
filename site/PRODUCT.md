...
- Parhlai uses a lightweight 30 fps desktop capture because its production `SAMEORIGIN` policy blocks cross-site iframe use. AV1 is preferred with an H.264 fallback, and the static capture remains the reduced-motion poster.
