...
- Parhlai uses one lightweight 60 fps H.264 desktop capture because its production `SAMEORIGIN` policy blocks cross-site iframe use. The static capture remains the reduced-motion poster.
