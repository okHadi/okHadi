...
- Architected the full backend with async event-driven ML pipelines for MCQ generation and content moderation
- Maintained a multi-cloud serverless AWS/Cloudflare backend with ~1% infrastructure cost via Terraform
- Built an in-product chatbot using Cloudflare Workers, Groq, Durable Objects, and Cloudflare KV for low-latency AI inference
